...
import com.example.mystory.databinding.ActivityAuthBinding
...
class AuthActivity : AppCompatActivity() {
    ...
    private inner class AuthPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
        ...
        override fun getPageTitle(position: Int): CharSequence? {
            ...
            // Apply animation
            val fadeInAnimator = ObjectAnimator.ofFloat(spannableString, "alpha", 0f, 1f)
            fadeInAnimator.duration = 500 // Set the duration of the animation
